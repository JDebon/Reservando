...
Aplicacion.prototype.dibujarCiudades = function() {
    ...
    this.listado.obtUbicacion().forEach(function(ciudad) {
...
Aplicacion.prototype.dibujarRubros = function() {
    ...
    this.listado.obtRubro().forEach(function(rubro) {
        var nuevaOpcion = $('<option/>')
            .text(rubro)
            .val(rubro);
...
Aplicacion.prototype.dibujarHorarios = function() {
    ...
    this.listado.obtHorarios().forEach(function(horario) {
        var nuevaOpcion = $('<option/>')
            .text(horario)
            .val(horario);
...
Aplicacion.prototype.filtrarRestaurantes = function() {
    if (
        $('#filtro-rubro option:selected').val() === '1' ||
        $('#filtro-rubro option:selected').val() === '0'
    ) {
    ...
    if (
        $('#filtro-ciudad option:selected').val() === '1' ||
        $('#filtro-ciudad option:selected').val() === '0'
    ) {
    ...
    var restaurantesFiltrados = this.listado.obtenerRestaurantes(
        filtroRubro,
        filtroCiudad,
        filtroHorario
    );
